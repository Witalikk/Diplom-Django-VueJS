"""
Django settings for AutoHomeProject project.
...
ROOT_URLCONF = 'AutoHomeProject.urls'
...
WSGI_APPLICATION = 'AutoHomeProject.wsgi.application'
...
AUTH_USER_MODEL = 'AutoHomeApp.User'
