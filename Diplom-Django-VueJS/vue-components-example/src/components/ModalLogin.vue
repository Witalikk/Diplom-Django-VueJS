<template>
  <div class="normal-case tracking-normal">
    ...
    <modal name="modal-login" :adaptive="true" :height="440" :width="400">
      <div class="px-10 py-8">
        ...
        <form @submit="login">
          <div class="form-group mb-4">
            ...
            <input v-model="username" type="text"  class="border px-4 py-2 w-full rounded bg-gray-200" >
          </div>
          <div class="form-group mb-4">
            <label for="password" class="block font-normal uppercase tracking-wide text-xs mb-1">Password</label>
            <input v-model="password" type="password" class="border px-4 py-2 w-full rounded bg-gray-200">
          </div>
        ...
        <div class="text-sm font-normal text-center">
          <p>VK <a href="/login/vk-oauth2" class="text-blue-600 hover:text-blue-800" @keydown.tab.exact.prevent="">VK</a></p>
        </div>
        <div class="text-sm font-normal text-center">
